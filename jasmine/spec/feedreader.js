...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        /* This is our second test - it ensures that when the
         * loadFeed function is called and completes its work, each
         * entry is unique within the .feed container. This test is
         * asynchronous, so this test requires the use of Jasmine's
        ...
        /* This is our third test - it ensures that when the
         * loadFeed function is called and completes its work, it
         * will call the callback function provided as a parameter
         * to the loadFeed function call. While this ability is
         * indirectly verified through jasmine's asynchronous done()
         * function, this test checks an added value in the callback
         * function to verify it was run.
         */
    ...
    describe('Feed Modification', function() {
         ...
         */
        it('is able to add a new feed', function() {
            feed = {
                name: 'RSS Tutorial',
        ...
        /* This is our second test - it ensures new feeds added to
         * the feed list are required to have a name.
         */
        it('requires new feeds to have names', function() {
            feed = {
                url: 'http://www.w3schools.com/rss'
            };
        ...
        /* This is our third test - it ensures new feeds added to the
         * feed list are required to have a url.
         */
        it('requires new feeds to have urls', function() {
            feed = {
                name: 'RSS Tutorial'
            };
        ...
        /* This is our fourth test - it ensures a feed can be deleted
